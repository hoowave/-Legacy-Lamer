...
<div class="container-fluid h-75">
	<div class="row mb-3">
		...
		<div class="col text-center">
			<p class="h3 mb-5">압축파일의 암호를 찾아보세요.</p>
			<div class="mb-3">
  ...
  <path
			...
			<div class="mb-5 option_default file_tooltip" data-toggle="tooltip"
				...
				title="허용하는 확장자<br>.zip .rar .7z .egg .tar .gz">
				<label for="defaultfile" class="form-label">압축파일 선택</label> <input
			...
			<div class="d-grid gap-2 col-6 mx-auto">
				<button id="archivebtn" class="btn btn-outline-success"
					type="button" onclick="archive();">Decryption</button>
...
<script>
	$(function() {
		$("#defaultfile").on("change", function() {
			...
			if (!archivechk(filename)) {
				alert("확장자가 .zip .rar .7z .egg .tar .gz인\n파일만 업로드 할 수 있습니다.");
				$(this).val("");
				return false;
			}
		});
